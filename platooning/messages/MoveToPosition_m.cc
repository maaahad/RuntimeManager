...
void MoveToPosition::setNewPlatoonFormationArraySize(unsigned int size)
{
...
unsigned int MoveToPosition::getNewPlatoonFormationArraySize() const
{
    return newPlatoonFormation_arraysize;
}

int MoveToPosition::getNewPlatoonFormation(unsigned int k) const
{
...
void MoveToPosition::setNewPlatoonFormation(unsigned int k, int newPlatoonFormation)
{
    if (k>=newPlatoonFormation_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", newPlatoonFormation_arraysize, k);
...
MoveToPositionDescriptor::MoveToPositionDescriptor() : omnetpp::cClassDescriptor("MoveToPosition", "ManeuverMessage")
{
...
int MoveToPositionDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MoveToPosition *pp = (MoveToPosition *)object; (void)pp;
    switch (field) {
...
const char *MoveToPositionDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string MoveToPositionDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool MoveToPositionDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *MoveToPositionDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
