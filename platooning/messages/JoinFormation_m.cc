...
void JoinFormation::setNewPlatoonFormationArraySize(unsigned int size)
{
...
unsigned int JoinFormation::getNewPlatoonFormationArraySize() const
{
    return newPlatoonFormation_arraysize;
}

int JoinFormation::getNewPlatoonFormation(unsigned int k) const
{
...
void JoinFormation::setNewPlatoonFormation(unsigned int k, int newPlatoonFormation)
{
    if (k>=newPlatoonFormation_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", newPlatoonFormation_arraysize, k);
...
JoinFormationDescriptor::JoinFormationDescriptor() : omnetpp::cClassDescriptor("JoinFormation", "ManeuverMessage")
{
...
int JoinFormationDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    JoinFormation *pp = (JoinFormation *)object; (void)pp;
    switch (field) {
...
const char *JoinFormationDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string JoinFormationDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool JoinFormationDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *JoinFormationDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
